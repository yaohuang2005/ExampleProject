...
public:
    ...
    static bool incensitiveEquals(const std::string& str1, const std::string& str2);

    static std::string concatStringInt(const std::string &a, int b) ;
    ...
    template <typename T>
    static std::string to_string(const T& thing);
    template <>
    static std::string to_string<std::string>(const std::string& s);
